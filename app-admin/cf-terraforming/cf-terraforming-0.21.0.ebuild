...
DESCRIPTION="Terraform importer for Cloudflare"
...
# Portage.
# SRC_URI="https://codeload.github.com/cloudflare/cf-terraforming/tar.gz/v${PV} -> ${P}.tar.gz"
SRC_URI="https://github.com/cloudflare/cf-terraforming/releases/download/v0.21.0/cf-terraforming_${PV}_linux_amd64.tar.gz -> ${P}.tar.gz"
